      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center mb-4">
              <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center mr-3">
                <span className="text-charcoal-gray font-bold text-sm">SCB</span>
              </div>
              <span className="text-white font-semibold text-xl">SCB Data</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>hello@scbdata.com</li>
              <li>+1 (555) 123-4567</li>
              <li>Based in San Francisco</li>
              <li>Serving brands worldwide</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 SCB Data. All rights reserved.
          </p>
